              ...
              >
                ...
                <Offcanvas.Body>
                  <Nav className="justify-content-end flex-grow-1 pe-3" variant="tabs" defaultActiveKey="#" justify>
                    ...
                    >
                      <NavDropdown.Item as={Link} to="/2D3DArt/2D3DArt" eventKey="2D/3D Art" href="/2D3DArt" style={{minWidth:'250px', width: '15vw'}}>
                        <NavItem className={styles.ddlink} icon={myIcons['image']} fontSize="1.0rem"><div className={styles.floatright}>2D/3D Art</div></NavItem>
                      </NavDropdown.Item>
                      <NavDropdown.Item as={Link} to={"/Music/Music"} eventKey="Music" href="#Music">
                      ...
                      <NavDropdown.Item as={Link} to={"/MartialArts/MartialArts"} eventKey="Martial Arts" href="#MartialArts">
                      ...
                      <NavDropdown.Item as={Link} to={"/CreativeWriting/CreativeWriting"} eventKey="Creative Writing" href="#CreativeWriting">
                      ...
                      <NavDropdown.Item as={Link} to={"/AudioVideo/AudioVideo"} eventKey="Audio/Video" href="#AudioVideo">
                      ...
                      <NavDropdown.Item as={Link} to={"/GameDev/GameDev"} eventkey="Game Dev" href="#GameDev">
                        <NavItem className={styles.ddlink} icon={myIcons['ghost']} fontSize="1.0rem"><div className={styles.floatright}>GAME DEV</div></NavItem>
                      </NavDropdown.Item>
                      <NavDropdown.Item as={Link} to={"/SoftwareDev/SoftwareDev"} eventKey="Software Dev" href="#SoftwareDev">
                      ...
                      <NavDropdown.Divider />
                      <NavDropdown.Item as={Link} to={"/GitHubLinks/GitHubLinks"} eventKey="GitHub Links" href="#GitHubLinks">
                        <NavItem className={styles.ddlink} icon={myIcons['codeBranch']} fontSize="1.0rem">GitHub LINKS</NavItem>
                      </NavDropdown.Item>
                      <NavDropdown.Item as={Link} to={"/YouTubeLinks/YouTubeLinks"} eventKey="YouTube Links" href="#YouTubeLinks">
